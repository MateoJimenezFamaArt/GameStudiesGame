...
public class CorridorNode: Node
{
    ...
    {
        var relativePoistionOfStructure2 = CheckPositionsStructure2AgainstStructure1();
        switch( relativePoistionOfStructure2)
        {
    ...
    private void ProcessRoomInRelationRightOrLeft(Node structure1, Node structure2)
    {
        ...
        var possibleNeighboursInRightStructureList = rightStructureChildren.Where(
            child => GetValidYorNeighbourLeftRight(
        ...
        int y = GetValidYorNeighbourLeftRight(leftStructure.TopLeftAreaCorner, leftStructure.BottomRightAreaCorner, 
        ...
        while(y == -1 && sortedLeftStructure.Count > 1 )
        {
            ...
            leftStructure = sortedLeftStructure[0];
            y = GetValidYorNeighbourLeftRight(leftStructure.TopLeftAreaCorner, leftStructure.BottomRightAreaCorner, 
            rightStructure.TopLeftAreaCorner, 
            rightStructure.BottomLeftAreaCorner);
        }
    ...
    private int GetValidYorNeighbourLeftRight(Vector2Int leftNodeUp, Vector2Int leftNodeDown, Vector2Int rightNodeUp, Vector2Int rightNodeDown)
    {
        ...
        if (rightNodeUp.y <= leftNodeUp.y && leftNodeDown.y <= rightNodeDown.y)
        {
                return StructureHelper.CalculatemiddlePoint(
                 ...
                 rightNodeDown - new Vector2Int(0,modifierDistanceFromWall + this.corridorWidth)
            ).y;
        }
    ...
    private void ProcessRoomInRelationUpOrDown(Node structure1, Node structure2)
    {
        ...
        var possibleNeighboursInTopStructure = structureAboveChildren.Where(
            child => GetValidXforNeighbourUpDow(
        ...
        int x = GetValidXforNeighbourUpDow(
                bottomStructure.TopLeftAreaCorner,
                bottomStructure.TopRightAreaCorner,
    ...
    private int GetValidXforNeighbourUpDow(Vector2Int bottomNodeLeft, Vector2Int bottomNodeRight, Vector2Int topNodeLeft, Vector2Int topNodeRight)
    {
    ...
    private RelativePosition CheckPositionsStructure2AgainstStructure1()
    {
